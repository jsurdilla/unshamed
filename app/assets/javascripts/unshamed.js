...
setupRootProperties.$inject = ['$rootScope', '$auth', '$state', '$stateParams', '$pusher', '$http', 'friendRequestSvc'];
function setupRootProperties($rootScope, $auth, $state, $stateParams, $pusher, $http, friendRequestSvc) {
  $rootScope.$auth = $auth;

    ...
    render: function() {
      return (
        <div id='status-update'>
          <textarea placeholder="How are you today?" onFocus={this.showActionsPanel} onChange={this.setSubmitButtonState} ref='updateText'></textarea>
          <div className='action clearfix' ref='actionsPanel'>
            <button className='btn btn-sm btn-primary pull-right' disabled={!this.state.okToSubmit} onClick={this.postStatusUpdate} ref='submitButton'>Post</button>
          </div>
        </div>
      );
    }

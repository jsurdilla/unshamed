    ...
    render: function() {
      ...
      return (
        <div className={classNames.join(' ')}>
          ...
          <TimelineItemBody item={item} onSupportClick={this.handleSupportClick} />
          <TimelineItemPropsCount item={item} />
          <TimelineItemCommentsSection item={item} onCommentSubmit={this.handleCommentSubmit} onViewMore={this.handleViewMoreComments} />
        </div>
      );
    },
